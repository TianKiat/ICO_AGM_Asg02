...
public class PauseMenu : MonoBehaviour
{
    ...
    public float backBtnX;
    public float statsY;
    public int toolbarWidth = 300;
    public int mainMenuWidth = 300;
    public int creditsWidth = 300;
	public string[] credits= {
		"A FrozenPunch Production",
		"Project leader: Ng Tian Kiat",
        "Vice project leader: Liao Ke Yi",
		"FrozenPunch logo by Ng Tian Kiat",
	...
	void ShowToolbar() {
		BeginPage(toolbarWidth, toolbarWidth);
	...
	void ShowCredits() {
		BeginPage(creditsWidth, creditsWidth);
	...
	void ShowBackButton() {
		if (GUI.Button(new Rect(backBtnX, Screen.height - 50, 50, 20),"Back")) {
			currentPage = Page.Main;
		}
	}
	...
	void ShowStatNums() {
		GUILayout.BeginArea( new Rect(Screen.width - 100, statsY, 100, 200));
		if (showfps) {
	...
	void MainPauseMenu() {
		BeginPage(mainMenuWidth, mainMenuWidth);
